  ...
  $.fn.tableExport = function (options) {
    var defaults = {
      ...
      jspdf: {                          // jsPDF / jsPDF-AutoTable related options
        ...
        margins:           {left: 20, right: 10, top: 100, bottom: 10},
        onDocCreated:      null,
        autotable: {
          styles: {
            cellPadding:   2,
    ...
    if ( defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt' ) {
      ...
      if ( defaults.pdfmake.enabled === true ) {
        ...
        // https://github.com/simonbengtsson/jsPDF-AutoTable
          ...
          //    doc.text("Testing Report", 20, 50);
          //};

          //defaults.jspdf.autotable.beforePageContent = header;

          //defaults.jspdf.text = "This is a sample text", 10, 30;
